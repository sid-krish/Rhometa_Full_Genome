...
if __name__ == "__main__":
    ...
    # Downsample pairwise table by keeping only 1% of data so that there is a similar number of entries as the read based pairwise table
    downsampled_final_df = final_df.sample(frac=0.01, replace=False, random_state=123, axis=0)

    export_final_df(downsampled_final_df)
