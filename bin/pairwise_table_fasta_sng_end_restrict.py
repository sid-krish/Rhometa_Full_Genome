...
def get_var_pos_pairs(var_pos, single_end_restrict):
    """
    ...
    while var_pos:  # while list not empty
        ...
        for i in var_pos:  # once last item is popped this will stop
            ...
            if difference <= single_end_restrict:
                pos1.append(start)
                pos2.append(i)
...
if __name__ == "__main__":
    ...
    single_end_restrict = int(sys.argv[3])
    ...
    pos1, pos2 = get_var_pos_pairs(variant_positions, single_end_restrict)
